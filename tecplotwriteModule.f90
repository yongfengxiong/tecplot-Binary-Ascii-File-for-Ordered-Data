module tecplotwrite
        ...
        do k = 1, data2Write%KMax    
            do j = 1, data2Write%JMax
                do i = 1, data2Write%IMax        
                    write(iunitWrite) data2Write%data(i,j,k,1:data2Write%Nvars)
                end do
            end do
        end do
    ...
    subroutine tecplot_write_ascii(data2Write)
        ...
        !datapacking = point
        write(iunitWrite,"(A)") 'F=POINT'! 
        CountInLine = 0
        do k = 1, data2Write%KMax
            do j = 1, data2Write%JMax
                do i = 1, data2Write%IMax
                    write(iunitWrite, "(ES18.9, $)") data2Write%data(i,j,k,1:data2Write%Nvars)
                end do
            end do
        end do
